...
define Device/tplink_archer-ax80-v1-eu-ubi
  DEVICE_VENDOR := TP-Link
  DEVICE_MODEL := Archer AX80 v1 (EU, UBI)
  DEVICE_DTS := mt7986b-tplink-archer-ax80-v1-eu-ubi
  DEVICE_DTS_DIR := ../dts
  DEVICE_DTC_FLAGS := --pad 4096
  DEVICE_DTS_LOADADDR := 0x43f00000
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7986-firmware mt7986-wo-firmware
  ...
  IMAGE/sysupgrade.itb := append-kernel | \
        ...
        append-metadata
  ARTIFACTS := bl31-uboot.fip preloader.bin
  ARTIFACT/bl31-uboot.fip := mt7986-bl31-uboot tplink_archer-ax80-v1-eu
  ARTIFACT/preloader.bin := mt7986-bl2 spim-nand-ubi-ddr3
endef
TARGET_DEVICES += tplink_archer-ax80-v1-eu-ubi
