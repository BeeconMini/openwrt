...
define Device/cradlepoint_brulk
	...
	IMAGE/sysupgrade.bin = copy-vmlinux | gzip | cradlepoint-kernel-packing | fit gzip $$(KDIR)/image-$$(DEVICE_DTS).dtb | pad-extra 896 | sysupgrade-tar kernel=$$$$@ | append-metadata
	DEVICE_PACKAGES += kmod-mmc ath10k-firmware-qca9984 kmod-spi-dev kmod-hwmon-lm90 cradlepoint-fstab-brulk cradlepoint-brulk-qca9984 kmod-fs-f2fs
endef

define Device/cradlepoint_ibr1700
	$(call Device/cradlepoint_brulk)
	DEVICE_MODEL := IBR1700
	DEVICE_PACKAGES += kmod-ads7924
endef
